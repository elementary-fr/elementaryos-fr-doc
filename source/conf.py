# -*- coding: utf-8 -*-
#
# Guide non-officiel du développeur EElementary OS documentation build configuration file, created by
...
htmlhelp_basename = 'Guidenon-officieldudveloppeurEElementaryOSdoc'
...
latex_documents = [
  ('index', 'Guidenon-officieldudveloppeurEElementaryOS.tex', project,
...
man_pages = [
    ('index', 'guidenon-officieldudveloppeureelementaryos', project,
